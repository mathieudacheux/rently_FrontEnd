  ...
  return (
    <div className='w-full flex justify-center'>
      <div className='w-8/12'>
        <Typography variant='h1'>Éditeur du Site:</Typography>
        ...
        <Typography variant='h1'>Directeur de la publication :</Typography>

        <Typography variant='text'>
          Charles Henri, en sa qualité de Directeur Général.
        </Typography>

        <Typography variant='h1'>Hébergement du Site :</Typography>
        <Typography variant='text'>
        ...
        <Typography variant='text'>
          Conformément à la loi [nom de la loi] relative à l&rsquo;informatique,
          aux fichiers et aux libertés, ainsi qu&rsquo;au Règlement Général sur
          la Protection des Données (RGPD), toute personne dispose d&rsquo;un
          droit d&rsquo;accès, de rectification, de suppression et
          d&rsquo;opposition aux données personnelles la concernant. Pour
          exercer ces droits, adressez-vous à : privacy@rently.com.
        </Typography>

        <Typography variant='h1'>Propriété intellectuelle :</Typography>
        ...
        <Typography variant='h1'>Limitation de responsabilité :</Typography>
        ...
        <Typography variant='h1'>Loi applicable :</Typography>
