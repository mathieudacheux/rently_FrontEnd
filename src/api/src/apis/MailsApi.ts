...
function mailsConfirmAccountMailRaw<T>(
  ...
  if (requestParameters.id === null || requestParameters.id === undefined) {
    throw new runtime.RequiredError(
      'id',
      'Required parameter requestParameters.id was null or undefined when calling mailsConfirmAccountMail.',
    )
  }
  ...
  const config: QueryConfig<T> = {
    url: `${runtime.Configuration.basePath}/mail/mail_confirm/{id}`.replace(
      `{${'id'}}`,
...
function mailsResetPasswordMailRaw<T>(
  ...
  if (requestParameters.id === null || requestParameters.id === undefined) {
    throw new runtime.RequiredError(
      'id',
      'Required parameter requestParameters.id was null or undefined when calling mailsResetPasswordMail.',
    )
  }
  ...
  meta.authType = ['bearer']
  const config: QueryConfig<T> = {
    url: `${runtime.Configuration.basePath}/mail/reset_password/{id}`.replace(
      `{${'id'}}`,
      encodeURIComponent(String(requestParameters.id)),
    ),
    meta,
