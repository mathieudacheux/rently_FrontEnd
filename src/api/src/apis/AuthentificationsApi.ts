 ...
 */
function authentificationsLoginRaw<T>(requestParameters: AuthentificationsLoginRequest, requestConfig: runtime.TypedQueryConfig<T, object> = {}): QueryConfig<T> {
...
* Login an user and return a token
*/
export function authentificationsLogin<T>(requestParameters: AuthentificationsLoginRequest, requestConfig?: runtime.TypedQueryConfig<T, object>): QueryConfig<T> {
