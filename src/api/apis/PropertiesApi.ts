 ...
 */
function propertiesGetPropertiesForHomeRaw<T>(requestParameters: PropertiesGetPropertiesForHomeRequest, requestConfig: runtime.TypedQueryConfig<T, Array<PropertySerializerRead>> = {}): QueryConfig<T> {
    let queryParameters = null;
...
* Return a list of 6 properties for the home page
*/
export function propertiesGetPropertiesForHome<T>(requestParameters: PropertiesGetPropertiesForHomeRequest, requestConfig?: runtime.TypedQueryConfig<T, Array<PropertySerializerRead>>): QueryConfig<T> {
