 ...
 */
function agenciesGetAllAgenciesRaw<T>( requestConfig: runtime.TypedQueryConfig<T, Array<AgencySerializerRead>> = {}): QueryConfig<T> {
    let queryParameters = null;
...
* Return a list of all agencies
*/
export function agenciesGetAllAgencies<T>( requestConfig?: runtime.TypedQueryConfig<T, Array<AgencySerializerRead>>): QueryConfig<T> {
