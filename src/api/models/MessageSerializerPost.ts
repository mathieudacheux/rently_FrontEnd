...
export function MessageSerializerPostFromJSON(json: any): MessageSerializerPost {
    return {
...
export function MessageSerializerPostToJSON(value?: MessageSerializerPost): any {
    if (value === undefined) {
        return undefined;
    }
    return {
