...
export function PropertySerializerPostFromJSON(json: any): PropertySerializerPost {
    return {
        ...
        'signature_date': !exists(json, 'signature_date') ? undefined : json['signature_date'],
        'property_type': !exists(json, 'property_type') ? undefined : json['property_type'],
        ...
        'fiber_deployed': !exists(json, 'fiber_deployed') ? undefined : json['fiber_deployed'],
        ...
        'life_annuity': !exists(json, 'life_annuity') ? undefined : json['life_annuity'],
        'ground_floor': !exists(json, 'ground_floor') ? undefined : json['ground_floor'],
