...
export function BadRequestFromJSON(json: any): BadRequest {
    return {
        ...
        'status': json['status'],
        'errors': !exists(json, 'errors') ? undefined : (json['errors'] as Array<any>).map(GenericErrorFromJSON),
...
export function BadRequestToJSON(value?: BadRequest): any {
    ...
    return {
        ...
        'status': value.status,
        'errors': value.errors === undefined ? undefined : (value.errors as Array<any>).map(GenericErrorToJSON),
        'stack': value.stack,
    };
}
