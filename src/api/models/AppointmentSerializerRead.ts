...
export function AppointmentSerializerReadFromJSON(json: any): AppointmentSerializerRead {
    return {
...
export function AppointmentSerializerReadToJSON(value?: AppointmentSerializerRead): any {
    if (value === undefined) {
        return undefined;
    }
    return {
